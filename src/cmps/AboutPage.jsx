...
export function AboutPage() {
    ...
    return (
        <section className="about-page flex row align-center">
            {/* <img src="https://res.cloudinary.com/dysh9q6ir/image/upload/v1706788350/%D7%9C%D7%9C%D7%90_%D7%A9%D7%9D_ngeib7.png" className="about-me-img" /> */}
            <div className='fs22 about-details flex column'>
                ...
                {/* <TypeAnimation className='fs32 underline bold'
                    sequence={["About me", 1000, "", 1, "About me", 1000]}
                    speed={50}
                    repeat={Infinity}
                /> */}
                My name is Noy Leibovich and I'm a
                <TypeAnimation
                    sequence={[" Programmer", 1000, " Developer", 1000]}
                    speed={50}
                    repeat={Infinity}
                />
                Seeking my frst role as a Full-Stack Developer, I bring a passion for coding, and
                detail-oriented attitude. Eager to apply my love for technology in a dynamic and
